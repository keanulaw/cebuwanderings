...
class Place2Activity : AppCompatActivity() {
    ...
    private val database = FirebaseDatabase.getInstance().reference.child("comments_place2")
    ...
    private fun showMessageDialog(position: Int) {
        ...
        usersDatabase.child(currentUser.uid).addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                AlertDialog.Builder(this@Place2Activity)
